...
$id3 	= $_GET['id'];
$poEdit	= query("SELECT * FROM tb_po WHERE id = $id3")[0];
// var_dump($poEdit);
// die;
...
<div class="container">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="no_po" name="no_po" value="<?= $poEdit['no_po'] ?>" >
    </div>
  </div>
    ...
    <div class="col-sm-10">
	  ...
	  <option value="<?= $poEdit['nama_brg'] ?>">Pilihan Saat ini <?= $poEdit['nama_brg'] ?></option>
 ...
 <?php 
	 ...
	 $jsArray .= "prdName['" . $row1['nama_brg'] . "'] = {uom:'" . addslashes($row1['uom']) . "', stock: '".addslashes($row1['stock'])."'};\n";
	  ...
	  ?>
			...
			<!-- "prdName['" . $row['nim'] . "'] = {nama_asesi:'" . addslashes($row['nama_asesi']) . "',kode_tuk:'".addslashes($row['kode_tuk'])."',nama_tuk:'".addslashes($row['nama_tuk'])."'};\n" -->
    </div>
  </div>
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
       <input class="form-control"  name="uom" id="uom" readonly value="<?= $poEdit['uom'] ?>" />    
    </div>
  </div>
 ...
 <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="number" class="form-control" id="total_order" name="total_order" value="<?= $poEdit['total_order'] ?>">
    </div>
  </div>
